...
save_correct = [data_sep['ConsumptionGV0 - Domme meter'][0:67], data_sep['ConsumptionKV3 - Slimme meter'][0:67], data_sep['ConsumptionKV0 - Domme meter'][0:66], data_sep['ProsumptionGV0 - Domme meter'][0:67], data_sep['ProsumptionKV3 - Slimme meter'][0:67], data_sep['ProsumptionKV0 - Domme meter'][0:66]]
...
final_mail_list.to_csv('data/final_mail_list.csv', index=True)
#print(data_sep)
